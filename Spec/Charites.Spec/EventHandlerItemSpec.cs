...
namespace Charites.Windows.Mvc
{
    ...
    {
        EventHandlerItemTss Item { get; set; }

        TestElement Element { get; } = new TestElement("Element1");
        ...
        Delegate CreateAsyncDelegate(string name) => typeof(EventHandlerAction).GetMethod(nameof(EventHandlerAction.OnHandled)).CreateDelegate(typeof(TwoArgumentsCallback), new EventHandlerAction(GetType().GetMethod(name, BindingFlags.NonPublic | BindingFlags.Instance), this));
