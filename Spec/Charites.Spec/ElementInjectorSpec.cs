...
class ElementInjectorSpec : FixtureSteppable
{
    ...
    TestControllers.IElementAssertController Controller { get; set; } = default!;
    TestElement RootElement { get; }
    TestElement ChildElement1 { get; } = new("childElement1");
    TestElement ChildElement2 { get; } = new("ChildElement2");
    TestElement ChildElement3 { get; } = new("ChildElement3");
