...
namespace Charites.Windows.Mvc
{
    ...
    public class ContentNavigator : IContentNavigator
    {
        ...
        /// </summary>
        protected virtual object CurrentContent { get; set; }

        /// <summary>
        /// Gets a collection representing the backward navigation history.
        /// </summary>
        protected virtual Stack<object> BackwardStack { get; } = new Stack<object>();

        /// <summary>
        /// Gets a collection representing the forward navigation history.
        /// </summary>
        protected virtual Stack<object> ForwardStack { get; } = new Stack<object>();
        ...
        /// <returns>
        /// <c>true</c> if the specified content is not null and its type is different from the current content type; otherwise, <c>false</c>.
        /// </returns>
        protected virtual bool CanNavigateTo(object content) => content != null && content.GetType() != CurrentContent?.GetType();
        ...
        protected virtual bool Navigate(ContentNavigationMode mode, object content, Action<object> navigationAction)
        {
            ...
            if (sourceContent != null && IsNavigationStackEnabled) navigationAction(sourceContent);
