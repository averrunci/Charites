...
namespace Charites.Windows.Mvc
{
    ...
    public abstract class ControllerTypeFinder<TElement> : IControllerTypeFinder<TElement> where TElement : class
    {
        ...
        /// </summary>
        protected virtual Func<Type, TElement, bool> ViewTypeFilter { get; } = (viewType, view) => viewType == null || viewType.IsInstanceOfType(view);
        ...
        IEnumerable<Type> IControllerTypeFinder<TElement>.Find(TElement view)
            => view == null ? Enumerable.Empty<Type>() : FindControllerTypes(view);
    }
}
